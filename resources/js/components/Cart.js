        ...
        <Fragment>
          ...
          <Container id='page-container'>
            ...
            <Container id='cart-empty-box'>
              ...
              <Button as={Link} to='/menu' color='red' size='large'>Go to Menu</Button>
            </Container>
          </Container>
          <Footer />
        </Fragment>
      ...
      <Fragment>
        ...
        <Container id='page-container'>
          <Container id='cart-header'>
            ...
            <Button as={Link} to='/menu' color='red' size='large' id='cart-menu-btn'>Back to Menu</Button>
          </Container>
          <Container id='order-box'>
            ...
            <Container id='cart-total'>
              ...
              <Button as={Link} to='/checkout' id='cart-checkout-btn' color='red' onClick={() => this.props.updateCheckoutTotal(checkoutTotal)}>Go to Payment</Button>
            </Container>
            </Container>
          </Container>
          <Footer />
